...
```{r, echo=FALSE, out.width="50%",fig.align = 'center',fig.cap = "The Nissan Xterra."}
...
```{r, echo=FALSE, out.width="50%",fig.align = 'center',fig.cap = "Getting stuck can happen! Be prepared to get yourself out."}
...
```{r, echo=FALSE, out.width="50%",fig.align = 'center',fig.cap="A job well done and ready to come home."}

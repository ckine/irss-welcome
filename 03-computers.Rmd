...
3. Once you have completed projects (or are done your time at the IRSS) you must backup your data on the data backup server `\\frst-irsstor\root\IRSSbackup`. See the next section for details on how to this needs to be done.

If you complete a project - its good practice to compress folders - create copies and get them on the server. This will allow you to free up space on your own internal HDD's and have piece of mind that your data is secure.
